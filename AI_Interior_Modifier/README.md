...
- **🔍 AI-Powered Detection**: Uses YOLOv8 to automatically detect furniture in room images
...
3. **Run the application**
   ...
   # Option 2: Run simple version directly
   streamlit run app_simple.py
   
   # Option 3: Run other versions
   streamlit run app_professional.py     # Professional version
   streamlit run app_streamlit_improved.py  # Enhanced version
   streamlit run app_streamlit.py          # Original version
   ```
...
├── app_simple.py              # Simple, user-friendly UI (RECOMMENDED)
├── app_professional.py        # Professional UI with advanced features
├── app_streamlit_improved.py  # Enhanced UI version
├── app_streamlit.py          # Original Streamlit app
├── run_app.py                # Launcher script (launches simple app)
├── test_system.py            # Comprehensive test suite
├── test_simple.py           # Simple UI test
...
- **Classes**: Supports 10+ furniture types (bed, sofa, chair, table, tv, etc.)
